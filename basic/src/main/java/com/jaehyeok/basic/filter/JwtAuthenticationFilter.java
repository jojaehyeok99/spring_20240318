package com.jaehyeok.basic.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter{
  ...
  // 2. 인증 토근을 발급받은 후 매 요청마다 인증 토큰을 request header의 Authorization 필드의 값으로 Bearer 토큰을 포함하여 요청
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
      throws ServletException, IOException {
        ...
        try {
          ...
          // 3. principle의 대한 정보를 controller 로 전달하기 위해 context에 담기
  ...
  private String parseBearerToken (HttpServletRequest request) {
    ...
    // ex. Bearer qwkjfsdkohsaskdwdsk -> 7번째 인덱스부터 토큰으로 가져옴
